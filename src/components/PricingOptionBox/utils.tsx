...
const popuarDiv =
  'flex flex-col px-[32px] py-[40px] items-start justify-between w-[353px] mobile-view-w-full h-[438px]  gap-[12px] bg-[#FFFFFF] boxShadow rounded-l-lg';

const notPopuar =
  'flex flex-col p-[32px] items-start justify-between w-[353px] mobile-view-w-full h-[402px]  gap-[12px] bg-[#F8F9FA] boxShadow rounded-l-lg';
