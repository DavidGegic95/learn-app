    ...
    <>
      ...
      >
        <div className='flex flex-col'>
          ...
          <input
            className={`profileIcon box-shadow-custom flex  pl-[32px] pr-1 bg-[#F3F4F6FF] rounded-lg border-0 w-full mv-custom-w-340px h-[40px]  font-poppins text-base leading-26 font-normal bg-[#F3F4F6FF] rounded-lg border-0 outline-none focus:text-[#171A1FFF] focus:outline-[#F3F4F6FF]  ${errors.email ? 'error-border' : ''}`}
            type='text'
            id='email'
            name='email'
        ...
        <div className='flex flex-col'>
          ...
          <div
            className={`box-shadow-custom focus-within:bg-white focus-within:border border-solid border-[#F3F4F6FF]  flex bg-[#F3F4F6FF] rounded-lg border-[1px] w-full mv-custom-w-340px h-[40px] ${errors.password ? 'error-border' : ''}`}
          >
            <input
